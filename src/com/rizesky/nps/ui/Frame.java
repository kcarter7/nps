package com.rizesky.nps.ui;
import com.rizesky.nps.Captor;
import com.rizesky.nps.NetworkPacketSniffer;
import com.rizesky.nps.stat.StatisticsTaker;
import com.rizesky.nps.stat.StatisticsTakerLoader;
...
public class Frame extends JFrame implements ActionListener
{
	...
	public Frame(Captor captor){
		...
		addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent evt){
				saveProperty();
				NetworkPacketSniffer.closeWindow((Frame)evt.getSource());
			}
		});
	...
	public void actionPerformed(ActionEvent evt){
		...
		if(cmd.equals("Open")){
			...
			NetworkPacketSniffer.openNewWindow();
			...
			try{
				...
				SwingUtilities.updateComponentTreeUI(NetworkPacketSniffer.chooser);
			}catch(Exception e){}
		}
	}
	...
	void loadProperty(){
		setSize(Integer.parseInt(NetworkPacketSniffer.JDProperty.getProperty("WinWidth","300")),
		        Integer.parseInt(NetworkPacketSniffer.JDProperty.getProperty("WinHeight","300")));
		setLocation(Integer.parseInt(NetworkPacketSniffer.JDProperty.getProperty("WinX","0")),
			Integer.parseInt(NetworkPacketSniffer.JDProperty.getProperty("WinY","0")));
	}
	...
	void saveProperty(){
		...
		NetworkPacketSniffer.JDProperty.put("WinWidth",String.valueOf(getBounds().width));
		NetworkPacketSniffer.JDProperty.put("WinHeight",String.valueOf(getBounds().height));
		NetworkPacketSniffer.JDProperty.put("WinX",String.valueOf(getBounds().x));
		NetworkPacketSniffer.JDProperty.put("WinY",String.valueOf(getBounds().y));
		
		tablePane.saveProperty();
		
		NetworkPacketSniffer.saveProperty();
	}
