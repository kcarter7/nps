...
//        System.loadLibrary("jpacp.dll");
        String property = System.getProperty("java.library.path");
        List<String> libs =  Arrays.stream(property.split(";")).filter(e->e.contains("L:")).collect(Collectors.toList());

        libs.forEach(e-> System.out.println(e.toString()));
        try{
