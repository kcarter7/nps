...
import com.rizesky.nps.ui.CaptureDialog;
import com.rizesky.nps.ui.ContinuousStatFrame;
import com.rizesky.nps.ui.CumlativeStatFrame;
import com.rizesky.nps.ui.Frame;
import com.rizesky.nps.ui.StatFrame;
...
public class Captor {
	...
	public void loadPacketsFromFile() {
		...
		int ret = NetworkPacketSniffer.chooser.showOpenDialog(frame);
		if (ret == JFileChooser.APPROVE_OPTION) {
			String path = NetworkPacketSniffer.chooser.getSelectedFile().getPath();
			String filename = NetworkPacketSniffer.chooser.getSelectedFile().getName();
	...
	public void saveToFile() {
		...
		int ret = NetworkPacketSniffer.chooser.showSaveDialog(frame);
		if (ret == JFileChooser.APPROVE_OPTION) {
			File file = NetworkPacketSniffer.chooser.getSelectedFile();
